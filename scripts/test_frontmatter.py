...
Stdlib `unittest` rather than pytest-specific fixtures, so pytest still collects and
runs it: `uv run pytest scripts`.
"""
...
class ScalarTests(unittest.TestCase):
    ...
    def test_parses_scalars_and_ignores_blank_lines(self) -> None:
    ...
    def test_keeps_everything_after_the_first_colon(self) -> None:
...
class InlineListTests(unittest.TestCase):
    ...
    def test_parses_an_inline_list_into_stripped_items(self) -> None:
        """`scope: [a, b]` becomes a list, which is the only list-valued field in use."""
        fields, problems = parse_frontmatter(
            "scope: [scripts/,  CHANGELOG.md , docs/adr/]"
        )
        self.assertEqual(fields, {"scope": ["scripts/", "CHANGELOG.md", "docs/adr/"]})
        self.assertEqual(problems, [])

    def test_parses_an_empty_list_as_empty(self) -> None:
...
class WrappedValueTests(unittest.TestCase):
    ...
    def test_flags_an_indented_continuation_carrying_a_colon(self) -> None:
    ...
    def test_flags_an_indented_continuation_without_a_colon(self) -> None:
    ...
    def test_flags_an_unindented_continuation_carrying_a_colon(self) -> None:
    ...
    def test_flags_a_line_that_is_not_a_key_value_pair(self) -> None:
    ...
    def test_collects_every_problem_rather_than_the_first(self) -> None:
        """Two bad lines produce two problems, so one fix does not hide the next."""
        _, problems = parse_frontmatter("nonsense\nalso bad")
        self.assertEqual(
            problems,
            ["is not `key: value`: 'nonsense'", "is not `key: value`: 'also bad'"],
        )
...
class BlockSequenceTests(unittest.TestCase):
    ...
    def test_parses_an_indented_block_sequence(self) -> None:
    ...
    def test_a_bare_key_with_nothing_under_it_stays_empty(self) -> None:
    ...
    def test_a_wrap_after_a_sequence_key_is_still_caught(self) -> None:
...
class CommentTests(unittest.TestCase):
    ...
    def test_ignores_comments_wherever_they_sit(self) -> None:
...
class BlockScalarTests(unittest.TestCase):
    ...
    def test_flags_every_block_scalar_indicator(self) -> None:
    ...
    def test_allows_a_value_merely_starting_with_an_indicator(self) -> None:
...
class DuplicateKeyTests(unittest.TestCase):
    ...
    def test_flags_a_repeated_key_and_keeps_the_first(self) -> None:
